    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          res = _context2.sent;
          if (res.data.status === 'success') {
            // location.reload(true); // to reload the fresh page from the server istead of from cach
            window.setTimeout(function () {
              location.assign('/');
            }, 1000);
          }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /* eslint-disable */
var submitButton = document.getElementById('submmit--btn');
...
var updateSettings = exports.updateSettings = (0, _catchAsync.default)( /*#__PURE__*/function () {
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /* eslint-disable */
var stripe = Stripe('pk_test_51OjM5GSEttJtDWP6Peeic7Wh9Ku3iCsBOSkqjlSo6e0EVFl149M7M4gbYW33BbKfe6QXNJ7tFDnvHo4Gg04paQKX0062SgS8jP');
...
var displayMap = exports.displayMap = function displayMap(locations) {
  ...
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/nicemapsforme/clsd9f1gg000y01qu839y7z02',
    // style URL
    scrollZoom: false
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Password reset mail send successfully! Check your Gmail Account');
            window.setTimeout(function () {
              location.assign('/');
            }, 1500);
          }
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          if (_context2.t0.response.data.message === 'Invalid password reset token or it expired. Please try again') {
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"features.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getLocation1 = exports.getLocation = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
var getLocation1 = exports.getLocation1 = function getLocation1() {
  if (window.navigator) {
    //geolocation available

    window.navigator.geolocation.getCurrentPosition(successCallBack1, failureCallBack);
  }
};
var successCallBack = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(position) {
    var latitude, longitude, url, res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          latitude = position.coords.latitude;
          longitude = position.coords.longitude; // console.log(latitude, longitude);
          url = "/tours-within/8000/center/".concat(latitude, ",").concat(longitude, "/unit/mi");
          _context.prev = 3;
          _context.next = 6;
          return (0, _axios.default)({
            method: 'GET',
...
var successCallBack1 = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(position) {
    var latitude, longitude, url, res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          latitude = position.coords.latitude;
          longitude = position.coords.longitude; // console.log(latitude, longitude);
          url = "/distances/".concat(latitude, ",").concat(longitude, "/unit/mi"); // console.log(url);
          _context2.prev = 3;
          _context2.next = 6;
          return (0, _axios.default)({
            method: 'GET',
  ...
  return function successCallBack1(_x2) {
    return _ref2.apply(this, arguments);
  };
}();
...
var toursNearMe = document.getElementById('tours-near-me');
var distanceFromPoint = document.getElementById('distance-from-point');

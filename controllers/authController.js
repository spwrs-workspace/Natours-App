...
exports.protect= catchAsync(async (req, res, next)=>{
  ...
  //console.log(freshUser);
  if(freshUser.passwordChangedAfter(decoded.iat)){
    return next(new AppError('You have recently changed your password. please login again', 401))
  }
...
exports.forgotPassword= catchAsync(async (req, res, next)=>{
  ...
  try{
    ...
    return next(new AppError('Error during sending mail. please try after few minutes', 500))
...
exports.resetPassword= catchAsync(async (req, res, next)=>{
  ...
  if(!user){
    return next(new AppError('Invalid password reset token or it expired', 400))
  }
